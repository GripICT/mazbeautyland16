...
* 1.9.0 (2022-11-XX)
    ...
    - Fix for applying discounts from Prestashop.
    ...
    - Allow to save information from Prestashop “other“ field to any text field in Odoo on res.partner model.
    - Fix auto-workflow action “Validate Picking“ not validating pickings in case of multi-step delivery.
    - Force sending products to the Prestashop is now working also if automatic products export from Odoo is disabled.
